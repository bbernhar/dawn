...
namespace dawn_native {
    ...
    void DeviceBase::ShutDownBase() {
        ...
        // Release the persistent cache after ShutDownImpl so any cached pipelines may be stored to disk.
    ...
    ResultOrError<ComputePipelineBase*> DeviceBase::GetOrCreateComputePipeline(
        ...
        DAWN_TRY_ASSIGN(backendObj, CreateComputePipelineImpl(descriptor, blueprintHash));
        backendObj->SetIsCachedReference();
        backendObj->SetContentHash(blueprintHash);
    ...
    ResultOrError<RenderPipelineBase*> DeviceBase::GetOrCreateRenderPipeline(
        ...
        DAWN_TRY_ASSIGN(backendObj, CreateRenderPipelineImpl(descriptor, blueprintHash));
        backendObj->SetIsCachedReference();
        backendObj->SetContentHash(blueprintHash);
