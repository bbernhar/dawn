...
#define ASSERT_SUCCESS(hr)            \
    ...
    class Device : public DeviceBase {
      public:
        ...
        Ref<TextureBase> CreateSharedTexture(const ExternalImageDescriptor* descriptor,
                                             ComPtr<ID3D12Resource> d3d12Texture);
        ComPtr<IDXGIKeyedMutex> CreateKeyedMutexForTexture(ID3D12Resource* d3d12Resource);
